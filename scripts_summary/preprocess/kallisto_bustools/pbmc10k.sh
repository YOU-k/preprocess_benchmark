...
seq_p="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/pbmc_data/raw_data/10k_pbmc"
dest_p="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/raw_results/kb"

fastq1=$seq_p/com10kpbmc_S1_L001_R1.fastq.gz
fastq2=$seq_p/com10kpbmc_S1_L001_R2.fastq.gz
