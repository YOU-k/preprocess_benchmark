...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/sc_3cl"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN76/fastq/combined_S0_L001_R1_001.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN76/fastq/combined_S0_L001_R2_001.fastq.gz"
print("###   trim barcode")
read_structure <- list(
