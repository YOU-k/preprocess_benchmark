...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/pbmc_data/raw_data/10k_pbmc/com10kpbmc_S1_L001_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/pbmc_data/raw_data/10k_pbmc/com10kpbmc_S1_L001_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
...
sc_detect_bc(
  ...
  max_reads = 50000000, number_of_cells = 12000,
