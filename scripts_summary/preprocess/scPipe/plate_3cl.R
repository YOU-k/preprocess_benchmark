...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/nn84-4"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN84/luyiT030118_nn84_NEXS2595/RPI4-TGACCA_S2_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN84/luyiT030118_nn84_NEXS2595/RPI4-TGACCA_S2_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
