...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/sc_5clv2_2"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/dsp/sc_5cl_v2/RAW_DATA/Lib90_combined_S1_L001_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/dsp/sc_5cl_v2/RAW_DATA/Lib90_combined_S1_L001_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
