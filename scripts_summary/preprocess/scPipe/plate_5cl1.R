...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/n110-4"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN110/daniela_NN110_060818/4_S2_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN110/daniela_NN110_060818/4_S2_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
