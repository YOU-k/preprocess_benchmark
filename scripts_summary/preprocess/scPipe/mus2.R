...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/mus2_2"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/mouse/data/result2/combined/bamtofastq_S1_L002_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/mouse/data/result2/combined/bamtofastq_S1_L002_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
