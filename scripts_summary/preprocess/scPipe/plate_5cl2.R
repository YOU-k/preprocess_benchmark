...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/n110-5"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN110/daniela_NN110_060818/5_S3_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN110/daniela_NN110_060818/5_S3_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
