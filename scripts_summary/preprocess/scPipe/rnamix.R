...
library(Rsubread)
data_dir = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/nn84-2"
...
##file path 
fq_R2="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN84/luyiT030118_nn84_NEXS2595/RPI2-CGATGT_S1_R1.fastq.gz"
fq_R1="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/NN84/luyiT030118_nn84_NEXS2595/RPI2-CGATGT_S1_R2.fastq.gz"
print("###   trim barcode")
read_structure <- list(
...
sc_count_aligned_bam(
  ...
  outdir = data_dir,
  bc_anno = "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/data/barcode_annotation7.csv"
)
