...
plate_info <- read.table("/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/data/demuxlet/sc_celseq2_5cl_p1.metadata.csv",sep=",",header = TRUE)
...
library(scPipe)
sc1_p <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/n110-4/"
...
#plotfc(scp_sc1_qc,"plate_5cl1/scpipe_rmout_fc")
...
saveRDS(gene_filter(sc1[,sc1$keep]),file.path(write.path,"plate5cl1_scpipe.rds"))

#plotfc(sc1,"plate_5cl1/scpipe_scater_fc")
...
zumis_path <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/zumis2/n110-4/zUMIs_output/expression"
zumis_sc1_data <- readRDS(file.path(zumis_path,"n110-4.dgecounts.rds"))
...
#plotfc(zumis_sc1,"plate_5cl1/zumis_scater_fc")
...
saveRDS(gene_filter(zumis_sc1[,zumis_sc1$keep]),file.path(write.path,"plate5cl1_zumis.rds"))

#celseq2
cs_path <-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/celseq2/n110-4/result/expr/sc4/"
...
#plotfc(celseq_sc1,"plate_5cl1/celseq_scater_fc")
...
saveRDS(gene_filter(celseq_sc1[,celseq_sc1$keep]),file.path(write.path,"plate5cl1_celseq.rds"))



###scruff
library(scruff)
scruff.path <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scruff/n110-4/Count"
load(file.path(scruff.path,"20200907_221523_countUMI_sce.rda"))
...
#plotfc(scruff_sc1,"plate_5cl1/scruff_scater_fc")
...
saveRDS(gene_filter(scruff_sc1[,scruff_sc1$keep]),file.path(write.path,"plate5cl1_scruff.rds"))

#kallisto 

library(Matrix)
kb_path <-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/kallisto_bus/n110-4/genecount"
...
kb_sc1$keep <-kb_f
#plotfc(kb_sc1,"plate_5cl1/kb_scater_fc")
...
saveRDS(gene_filter(kb_sc1[,kb_sc1$keep]),file.path(write.path,"plate5cl1_kb.rds"))
...
saveRDS(zero.d,"SCE/raw/zeros/plate_5cl1_zero.rds")

pdf("results/raw/plate_5cl1/zero_all.pdf",width = 5,height = 4)
...
pdf("results/raw/plate_5cl1/zero.pdf",width = 8,height = 4)
...
pdf("results/raw/plate_5cl1/total_counts_density.pdf",width = 5,height = 4)
...
saveRDS(gene_biotype,"SCE/raw/biotypes/plate_5cl1_gene_biotype.rds")
...
pdf("results/raw/plate_5cl1/biotype_count.pdf",width =6, height = 4)
...
plotglmpca(zumis_sc1,"plate_5cl1/glm/zumis_glm")
plotglmpca(sc1,"plate_5cl1/glm/scpipe_glm")
#plotglmpca(scp_sc1_qc,"plate_5cl1/glm/scpipe_rm_glm")
plotglmpca(celseq_sc1,"plate_5cl1/glm/celseq_glm")
plotglmpca(scruff_sc1,"plate_5cl1/glm/scruff_glm")
...
pdf("results/raw/plate_5cl1/upsetr.pdf",width = 5,height = 5)
...
pdf("results/raw/plate_5cl1/total_counts_boxplot.pdf",width = 5,height = 3.5)
...
apply_methods(datasets,libm) -> lib
pdf("results/raw/plate_5cl1/genes_boxplot.pdf",width = 5,height = 3.5)
...
pdf("results/raw/plate_5cl1/total_counts_overlap.pdf",width = 5,height = 3.5)
...
pdf("results/raw/plate_5cl1/genes_overlap.pdf",width = 5,height = 3.5)
...
saveRDS(dgenes,"SCE/raw/overlap/plate_5cl1_dgenes.rds")
saveRDS(umi_counts,"SCE/raw/overlap/plate_5cl1_umi_counts.rds")
...
saveRDS(cors,"SCE/raw/cor/plate_5cl1_cors.rds")

#filter 

bind_rows(filter.celseq,filter.kb,filter.scpipe,filter.scpipe.rm,filter.scruff,filter.zumis) ->filter.d
saveRDS(filter.d,"SCE/raw/filter/plate_5cl1_filter.rds")

library(ggsci)
#mito

pdf("results/raw/plate_5cl1/mito_filter.pdf")
...
#total
pdf("results/raw/plate_5cl1/total_filter.pdf",width = 6,height = 4)
...
#detected
pdf("results/raw/plate_5cl1/detected_filter.pdf",width = 6,height = 4)
