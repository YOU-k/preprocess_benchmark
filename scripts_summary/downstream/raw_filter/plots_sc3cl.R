...
saveRDS(zero.d,"SCE/raw/zeros/sc3cl_zero.rds")

pdf("results/raw/sc_3cl/zero_all.pdf",width = 5,height = 4)
...
pdf("results/raw/sc_3cl/zero.pdf",width = 10,height = 4)
...
#biotype
pdf("results/raw/sc_3cl/biotype.pdf",width = 10)
...
saveRDS(gene_biotype,"SCE/raw/biotypes/sc3cl_gene_biotype.rds")
...
ggplot(gene_biotype[!is.na(gene_biotype$gene_biotype),]) + geom_col(aes(x=preprocess,y=proportion,fill=gene_biotype)) + 
  ...
  theme(text = element_text(size=20)) +theme_bw()
dev.off()
pdf("results/raw/sc_3cl/biotype_count.pdf",width =6, height = 4)
...
plotglmpca(zumis_sc1,"sc_3cl/glm/zumis_glm")
plotglmpca(sc1,"sc_3cl/glm/scpipe_glm")
plotglmpca(cellrangr_sc,"sc_3cl/glm/cellranger_glm")
plotglmpca(kb_sc1,"sc_3cl/glm/kb_glm")
plotglmpca(alevin_sc,"sc_3cl/glm/alevin_glm")
plotglmpca(optimus_sc,"sc_3cl/glm/optimus_glm")
plotglmpca(drop_sc1,"sc_3cl/glm/drop_glm")
...
pdf("results/raw/sc_3cl/upsetr.pdf",width = 5,height = 5)
...
pdf("results/raw/sc_3cl/total_counts_violin.pdf",width = 5,height = 3.5)
...
apply_methods(datasets,libm) -> lib
pdf("results/raw/sc_3cl/genes_violin.pdf",width = 5,height = 3.5)
...
pdf("results/raw/sc_3cl/total_counts_overlap.pdf",width = 5,height = 3.5)
...
pdf("results/raw/sc_3cl/genes_overlap.pdf",width = 5,height = 3.5)
...
saveRDS(dgenes,"SCE/raw/overlap/sc3cl_dgenes.rds")
saveRDS(umi_counts,"SCE/raw/overlap/sc3cl_umi_counts.rds")
...
pdf("results/raw/sc_3cl/correlation.pdf",width = 5,height = 3.5)
...
saveRDS(umi_counts,"SCE/raw/cor/sc3cl_cors.rds")
...
saveRDS(filter.d,"SCE/raw/filter/sc3cl_filter.rds")

library(ggsci)

#mito

pdf("results/raw/sc_3cl/mito_filter.pdf")
...
#total
pdf("results/raw/sc_3cl/total_filter.pdf",width = 6,height = 4)
...
pdf("results/raw/sc_3cl/total_filter_density.pdf",width = 6,height = 4)
...
#detected
pdf("results/raw/sc_3cl/detected_filter.pdf",width = 6,height = 4)
