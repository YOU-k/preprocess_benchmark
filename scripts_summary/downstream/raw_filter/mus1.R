...
library(scPipe)
sc1_p <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/mus12_2"
...
library(fishpond)
library(tximport)
sal_ale_path<-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/raw_results/SA/mus1/output_white/alevin/"
alevin <- tximport(file.path(sal_ale_path,"quants_mat.gz"),type="alevin")
aalevin_filtered  <- alevin$counts[,defaultDrops(alevin$counts)]
