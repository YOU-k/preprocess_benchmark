...
saveRDS(zero.d,"SCE/raw/zeros/sc5clv3_zero.rds")

pdf("results/raw/sc_5clv3/zero_all.pdf",width = 5,height = 4)
...
pdf("results/raw/sc_5clv3/zero.pdf",width = 10,height = 4)
...
pdf("results/raw/sc_5clv3/total_counts_density.pdf",width = 5,height = 4)
...
#biotype
pdf("results/raw/sc_5clv3/biotype.pdf",width = 10)
...
saveRDS(gene_biotype,"SCE/raw/biotypes/sc5clv3_gene_biotype.rds")
...
saveRDS(col1,"SCE/raw/biotypes/col1.rds")

names(col1) <- c("IG_V_gene","TR_V_gene","transcribed_processed_pseudogene","TEC","snRNA","transcribed_unprocessed_pseudogene",
                 "unprocessed_pseudogene","misc_RNA","processed_pseudogene","lncRNA","protein_coding","IG_V_pseudogene")
ggplot(gene_biotype[!is.na(gene_biotype$gene_biotype),]) + geom_col(aes(x=preprocess,y=proportion,fill=gene_biotype)) + 
  scale_fill_manual(values=col) +
  theme(text = element_text(size=20)) +theme_bw()
dev.off()
col
pdf("results/raw/sc_5clv3/biotype_count.pdf",width =6, height = 4)
...
plotglmpca(zumis_sc1,"sc_5clv3/glm/zumis_glm")
plotglmpca(sc1,"sc_5clv3/glm/scpipe_glm")
plotglmpca(cellrangr_sc,"sc_5clv3/glm/cellranger_glm")
plotglmpca(kb_sc1,"sc_5clv3/glm/kb_glm")
plotglmpca(alevin_sc,"sc_5clv3/glm/alevin_glm")
plotglmpca(optimus_sc,"sc_5clv3/glm/optimus_glm")
plotglmpca(drop_sc1,"sc_5clv3/glm/drop_glm")
...
pdf("results/raw/sc_5clv3/upsetr.pdf",width = 5,height = 5)
...
pdf("results/raw/sc_5clv3/total_counts_violin.pdf",width = 5,height = 3.5)
...
apply_methods(datasets,libm) -> lib
pdf("results/raw/sc_5clv3/genes_violin.pdf",width = 5,height = 3.5)
...
pdf("results/raw/sc_5clv3/total_counts_overlap.pdf",width = 5,height = 3.5)
...
pdf("results/raw/sc_5clv3/genes_overlap.pdf",width = 5,height = 3.5)
...
saveRDS(dgenes,"SCE/raw/overlap/sc5clv3_dgenes.rds")
saveRDS(umi_counts,"SCE/raw/overlap/sc5clv3_umi_counts.rds")
...
pdf("results/raw/sc_5clv3/correlation.pdf",width = 5,height = 3.5)
...
saveRDS(umi_counts,"SCE/raw/cor/sc5clv3_cors.rds")
...
saveRDS(filter.d,"SCE/raw/filter/sc5clv3_filter.rds")

library(ggsci)

#mito

pdf("results/raw/sc_5clv3/mito_filter.pdf")
...
#total
pdf("results/raw/sc_5clv3/total_filter.pdf",width = 6,height = 4)
...
pdf("results/raw/sc_5clv3/total_filter_density.pdf",width = 6,height = 4)
...
#detected
pdf("results/raw/sc_5clv3/detected_filter.pdf",width = 6,height = 4)
