...
plate_info <- read.table("/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/data/demuxlet/sc_celseq2_5cl_p2.metadata.csv",sep=",",header = TRUE)
...
library(scPipe)
sc1_p <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scpipe/n110-5/"
...
#plotfc(scp_sc1_qc,"plate_5cl2/scpipe_rmout_fc")
...
saveRDS(gene_filter(sc1[,sc1$keep]),file.path(write.path,"plate5cl2_scpipe.rds"))

#plotfc(sc1,"plate_5cl2/scpipe_scater_fc")
...
zumis_path <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/zumis2/n110-5/zUMIs_output/expression"
zumis_sc1_data <- readRDS(file.path(zumis_path,"n110-5.dgecounts.rds"))
...
#plotfc(zumis_sc1,"plate_5cl2/zumis_scater_fc")
...
saveRDS(gene_filter(zumis_sc1[,zumis_sc1$keep]),file.path(write.path,"plate5cl2_zumis.rds"))

#celseq2
cs_path <-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/celseq2/n110-5/result/expr/N110-5/"
...
#plotfc(celseq_sc1,"plate_5cl2/celseq_scater_fc")
...
saveRDS(gene_filter(celseq_sc1[,celseq_sc1$keep]),file.path(write.path,"plate5cl2_celseq.rds"))



###scruff
library(scruff)
scruff.path <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/scruff/n110-5/Count"
load(file.path(scruff.path,"20200819_120000_countUMI_sce.rda"))
...
#plotfc(scruff_sc1,"plate_5cl2/scruff_scater_fc")
...
saveRDS(gene_filter(scruff_sc1[,scruff_sc1$keep]),file.path(write.path,"plate5cl2_scruff.rds"))

#kallisto 

library(Matrix)
kb_path <-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess/kallisto_bus/n110-5/genecount"
...
kb_sc1$keep <-kb_f
#plotfc(kb_sc1,"plate_5cl2/kb_scater_fc")
...
saveRDS(gene_filter(kb_sc1[,kb_sc1$keep]),file.path(write.path,"plate5cl2_kb.rds"))
...
saveRDS(zero.d,"SCE/raw/zeros/plate_5cl2_zero.rds")

pdf("results/raw/plate_5cl2/zero_all.pdf",width = 5,height = 4)
...
pdf("results/raw/plate_5cl2/zero.pdf",width = 8,height = 4)
...
pdf("results/raw/plate_5cl2/total_counts_density.pdf",width = 5,height = 4)
...
saveRDS(gene_biotype,"SCE/raw/biotypes/plate_5cl2_gene_biotype.rds")
...
pdf("results/raw/plate_5cl2/biotype_count.pdf",width =6, height = 4)
...
plotglmpca(zumis_sc1,"plate_5cl2/glm/zumis_glm")
plotglmpca(sc1,"plate_5cl2/glm/scpipe_glm")
#plotglmpca(scp_sc1_qc,"plate_5cl2/glm/scpipe_rm_glm")
plotglmpca(celseq_sc1,"plate_5cl2/glm/celseq_glm")
plotglmpca(scruff_sc1,"plate_5cl2/glm/scruff_glm")
...
pdf("results/raw/plate_5cl2/upsetr.pdf",width = 5,height = 5)
...
pdf("results/raw/plate_5cl2/total_counts_boxplot.pdf",width = 5,height = 3.5)
...
apply_methods(datasets,libm) -> lib
pdf("results/raw/plate_5cl2/genes_boxplot.pdf",width = 5,height = 3.5)
...
pdf("results/raw/plate_5cl2/total_counts_overlap.pdf",width = 5,height = 3.5)
...
pdf("results/raw/plate_5cl2/genes_overlap.pdf",width = 5,height = 3.5)
...
saveRDS(dgenes,"SCE/raw/overlap/plate_5cl2_dgenes.rds")
saveRDS(umi_counts,"SCE/raw/overlap/plate_5cl2_umi_counts.rds")
...
pdf("results/raw/plate_5cl2/correlation.pdf",width = 5,height = 3.5)
...
saveRDS(umi_counts,"SCE/raw/cor/plate_5cl2_cors.rds")

#filter 

bind_rows(filter.celseq,filter.kb,filter.scpipe,filter.scpipe.rm,filter.scruff,filter.zumis) ->filter.d
saveRDS(filter.d,"SCE/raw/filter/plate_5cl2_filter.rds")

library(ggsci)
#mito

pdf("results/raw/plate_5cl2/mito_filter.pdf")
...
#total
pdf("results/raw/plate_5cl2/total_filter.pdf",width = 6,height = 4)
...
#detected
pdf("results/raw/plate_5cl2/detected_filter.pdf",width = 6,height = 4)
