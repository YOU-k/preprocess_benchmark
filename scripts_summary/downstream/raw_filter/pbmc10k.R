...
barcode_info <- read.csv("/stornext/HPCScratch/home/you.y/preprocess_update/pbmc_data/10kpbmc/label_file.csv",header = TRUE)
...
library(scPipe)
sc1_p <- "/stornext/HPCScratch/home/you.y/preprocess_update/raw_results/scpipe/pbmc10k/"
sc1 <- create_sce_by_dir(sc1_p, organism = "hsapiens_gene_ensembl", gene_id_type="ensembl_gene_id")
sc1_barcode <- read.csv("/stornext/HPCScratch/home/you.y/preprocess_update/raw_results/scpipe/pbmc10k/barcode_anno.csv",header = TRUE)
...
sc1 <- sc1[,defaultDrops(counts(sc1),expected = 11000)]
...
saveRDS(sc11,file.path(write.path,"pbmc10k_scpipe.rds"))

#zumis

library(SingleCellExperiment)
zumis_path <- "/stornext/HPCScratch/home/you.y/preprocess_update/raw_results/zumis/pbmc10k_v2/zUMIs_output/expression/"
zumis_sc1_data <- readRDS(file.path(zumis_path,"pbmc10k.dgecounts.rds"))
...
saveRDS(zumis_sc11,file.path(write.path,"pbmc10k_zumis.rds"))

#kallisto 

library(Matrix)
kb_path <-"/stornext/HPCScratch/home/you.y/preprocess_update/raw_results/kb/pbmc10k/genecount/"
...
saveRDS(kb_sc11,file.path(write.path,"pbmc10k_kb.rds"))
...
library(fishpond)
library(tximport)
sal_ale_path<-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/raw_results/SA/pbmc10k/output/alevin/"
...
saveRDS(alevin_sc1,file.path(write.path,"pbmc10k_sa.rds"))


#splici
source("/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/raw_results/splici/load_fry.R")
splici_path <-"/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/tools/salmon/quants/pbmc10k/quant/"
af_all = load_fry(splici_path)
af_empty <- emptyDrops(counts(af_all))
saveRDS(af_empty,file.path(write.path,"pbmc10k_splici_empty.rds"))
...
saveRDS(af1,file.path(write.path,"pbmc10k_splici.rds"))


#dropseqpipe

dropseq_path <- "/stornext/General/data/user_managed/grpu_mritchie_1/Yue/preprocess_update/raw_results/dsp/pbmc10k/results/summary/umi/"
...
saveRDS(drop_sc11,file.path(write.path,"pbmc10k_drop.rds"))


#cellranger
cellr_path <-"/stornext/HPCScratch/home/you.y/preprocess_update/raw_results/cellranger/pbmc10k/pbmc_10k_v3/outs/raw_feature_bc_matrix/"
...
saveRDS(cellr_empty,file.path(write.path,"pbmc10k_cellranger_empty.rds"))
...
saveRDS(cellrangr_sc1,file.path(write.path,"pbmc10k_cellranger.rds"))
