...
droplet_singlecell_hvged <- readRDS(file.path(read.path,"droplet_singlecell_hvged.rds"))
...
droplet_singlecell_hvged %>% apply_methods(cluster_method) ->result2
saveRDS(result2,file.path(write.path,"droplet_singlecell.rds"))
###evaluation
library(mclust)
...
saveRDS(result3,file.path(write.path,"droplet_singlecell_evals.rds"))
