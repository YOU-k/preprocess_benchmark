...
readRDS("/stornext/HPCScratch/home/you.y/preprocess_update/pbmc_data/5k_pbmc/cd_rm.rds") -> cd_rms
...
saveRDS(result1,file.path(write.path,"pbmc5k_norm.rds"))
...
saveRDS(result2,file.path(write.path,"eval/pbmc5k_eval.rds"))
